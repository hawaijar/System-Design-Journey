...
graph TB
    subgraph "Problem: Uneven Distribution"
        P1[Server 0<br/>Position: 1000<br/>Handles: 90% of keys]
        P2[Server 1<br/>Position: 2000<br/>Handles: 5% of keys]
        P3[Server 2<br/>Position: 3000<br/>Handles: 5% of keys]
    end
    ...
    subgraph "Solution: Virtual Nodes"
        ...
        S1_1[S1-VNode1: 2000]
        S1_2[S1-VNode2: 6000]
        S1_3[S1-VNode3: 10000]

        S2_1[S2-VNode1: 3000]
        S2_2[S2-VNode2: 7000]
        S2_3[S2-VNode3: 11000]
    end
...
graph TB
    ...
    Problem[❌ No health checks<br/>❌ Uneven distribution<br/>❌ DNS caching issues]
